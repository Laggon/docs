...
Программное обеспечение, которое позволяет хранить историю изменения файлов в проекте. Изменениями могут быть: добавление файла, изменение существующего файла, удаление файла.
...
Распределенная система контроля версий. Так как система распределенная, она позволяет хранить репозиторий локально у каждого разработчика и в удаленном (remote) репозитории (GitHub/GitLab).
...
Обычно есть основная ветка проекта - main (ранее master), в которой храниться основная версия кода (для production).
